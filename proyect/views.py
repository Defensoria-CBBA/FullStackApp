...
from .serializer import personSerializer, tutorSerializer, employeeSerializer, childSerializer, tutor_childSerializer, class_groupSerializer, stablishmentsSerializer, scheduleSerializer, complaintSerializer, announcementsSerializer
from .models import person, tutor, employee, child, tutor_child, class_group, stablishments, schedule, complaint, announcements
